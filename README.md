...
Get started by going to our [guide](https://nextpeer.atlassian.net/wiki/display/NS/Cocos2d-x+2.x+Basic+Integration+Guide). The sample code is submodule Nextpeer's [Cocos2d-X plugin](https://github.com/Nextpeer/Nextpeer-Cocos2dx).
